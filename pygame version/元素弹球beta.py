...
for i in range(8):
    for j in range(15):
        a=Brick(brick_n,80+60*j,80+20*i)
        brickk[j+15*i]=a
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_ESCAPE:
                sys.exit()
        elif event.type == pygame.MOUSEMOTION and event.pos[0]>20 and event.pos[0]<980:
        ...
        if i.origin==ski_surfacelist[0]:
            ...
            if spe==3:
                for j in range(len(speed_list)):
                    speed_list[j][0]=speed_list[j][0]/spe*5
                    speed_list[j][1]=speed_list[j][1]/spe*5
                spe=5
            else:
                for j in range(len(speed_list)):
                    speed_list[j][0]=speed_list[j][0]/spe*8
                    speed_list[j][1]=speed_list[j][1]/spe*8
                spe=8
                set_timer[3]=0
            ...
            if spe==8:
                ...
                for j in range(len(speed_list)):
                    speed_list[j][0]=speed_list[j][0]/spe*3
                    speed_list[j][1]=speed_list[j][1]/spe*3
                spe=3
                set_timer[3]=0
